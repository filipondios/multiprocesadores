...
int main(int argc, char **argv)
{
   ...
   FILE *FPipeFFPlay;         // File handler of pipe for FFPlay
   ...
   // Initiate the seed of random numbers. Fix a number for repetition
   // TODO: Set to 0 or not.
   srand48(time(NULL));
   ...
   {
      puts("The number of animals > number of pixels");
      exit(1);
   }
